...
- (done, 2026-08-10) Android: virtual fallback injects keys via the internal `InputManager.injectInputEvent` API on SM-G977N / Android 12 — forced backend selection, single key delivery, modifier delivery, release behavior, metadata-only logging, and clean shutdown verified (issue #33)
