...
let package = Package(
    ...
    products: [
        ...
        .executable(name: "cxi-hid-seize-probe", targets: ["HIDSeizeProbe"])
    ],
    targets: [
        ...
        .executableTarget(name: "HIDSeizeProbe", dependencies: ["HIDSeizeProbeCore"], path: "Tools/HIDSeizeProbe"),
        .target(name: "HIDSeizeProbeCore", dependencies: [], path: "Tools/HIDSeizeProbeCore"),
        ...
        .testTarget(name: "HIDSeizeProbeCoreTests", dependencies: ["HIDSeizeProbeCore"])
    ]
)
